...
In the example below we find all workers that is available from a Service named `emyapp` and send a `ping` by [Nexus API](https://qepal.com/docs/2-0-adminpanel-nexus-api-send.md) to it.
