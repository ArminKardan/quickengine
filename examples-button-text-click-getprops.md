...
In below example the page / component will be loaded with `Initial value` in `props.btntext` and after user clicks on the button the page / component will re-render and the button's text will change to `Clicled!`.
```tsx
